package com.apiit.shoppingcart.database;
...
//        String itemID = values.getAsString(OrderContract.OrderEntry._ID);
//        if(itemID == null) {
...
//        }
        ...
        //adding to check id exists
       // Cursor csr = database.rawQuery("SELECT * FROM " + OrderContract.OrderEntry.TABLE_NAME + " WHERE _ID= " + itemID,null);
